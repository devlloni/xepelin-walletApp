...
const NavbarLoggedIn = ({ navigation, userNavigation, classNames, sessionImage, session, signOut } : NavbarLoggedinProps) => {
  return (
    <>
                                        ...
                                        <Menu as="div" className="relative ml-3">
                                            <div>
                                                <Menu.Button className="relative flex max-w-xs items-center rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                                                    ...
                                                    <img className="h-8 w-8 rounded-full" src={sessionImage} alt="" />
                                                </Menu.Button>
                                            </div>
                                            <Transition
                                                as={Fragment}
                        ...
                        <Disclosure.Panel className="md:hidden">
                            ...
                            <div className="border-t border-gray-700 pb-3 pt-4">
                                <div className="flex items-center px-5">
                                    <div className="flex-shrink-0">
                                        <img className="h-10 w-10 rounded-full" src={sessionImage} alt="" />
                                    </div>
                                    <div className="ml-3">
